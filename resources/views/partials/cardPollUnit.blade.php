<div class="card border border-0 shadow-sm rounded-3 mb-3" data-aos="zoom-out" data-aos-duration="500">
  <div class="card-body">
    <div class="row d-flex align-items-center">
      <div class="col-md-3 d-flex justify-content-center justify-content-md-start">
        <img src="img/imgsmp.jpeg" alt="" class="img-fluid rounded img_card mb-3 mb-md-0">
      </div>
      <div class="col-md-9">
        <a href="/pollingUnit"><h5><strong>Bogor Memilih 2024, Siapa Kandidat Balon Wali Kota Bogor Terfavorit?</strong></h5></a>
        <p class="text-muted mb-1">PEMILIHAN  Wali Kota Bogor akan digelar pada 2024 mendatang. Sejumlah nama digadang-gadang bakal maju...</p>
        ...
        <a href="/pollingUnit" class="btn btn-outline-primary btn-sm float-md-end" type="button">Ikuti Polling</a>
      </div>
    </div>
  </div>
</div>

  <div class="card border border-0 shadow-sm rounded-3 mb-3" data-aos="zoom-out" data-aos-duration="1000">
    <div class="card-body">
      <div class="row d-flex align-items-center">
        <div class="col-md-3 d-flex justify-content-center justify-content-md-start">
          <img src="img/wisata bgr.png" alt="" class="img-fluid rounded img_card mb-3 mb-md-0">
        </div>
        <div class="col-md-9">
