<div class="card border border-0 shadow-sm rounded-3 mb-3">
    <div class="card-body">
      <div class="row d-flex align-items-center">
        <div class="col-md-2">
          <img src="img/Dedi A Rachim.jpg" alt="" class=" img-fluid rounded">
        </div>
        <div class="col-md-10">
    ...
    <div class="card-body">
      <div class="row d-flex align-items-center">
        ...
        <div class="col-md-10">
          ...
          <a href="/viewPollUnit" class="btn btn-outline-primary btn-sm float-md-end" type="button">Lihat Polling</a>
        </div>
      </div>
    </div>
  </div>