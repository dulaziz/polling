...
<div class="col-md-10 mx-auto my-5">
  ...
  <div class="row g-0 d-flex align-items-center my-5">
    <div class="col-md-4 mb-2 mb-md-0 d-flex justify-content-center justify-content-md-start">
        <img class="img_thumb img-fluid" data-aos="flip-left" data-aos-duration="1500" src="/img/Dedi A Rachim.jpg" alt="...">
    </div>
          ...
          <div class="tab-pane fade show active" id="history" role="tabpanel" aria-labelledby="history-tab">
            <div class="row g-0 d-flex align-items-center">
              <div class="col-md-3 d-flex justify-content-center">
                  <img src="/img/parchment.png" alt="..." class="img-fluid" style="max-width: 150px;" data-aos="fade-left" data-aos-duration="1500">
              </div>
              <div class="col-md-9">
