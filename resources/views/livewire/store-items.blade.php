<div>
    ...
    <form wire:submit.prevent="storeItems" method="post" id="image-form" enctype="multipart/form-data">
        ...
        <div id="form_item_add">
            {{-- <input type="hidden" name="vote_unit_id" value="{{$vote_unit_id}}" wire:model="vote_unit_id"> --}}
            @error('vote_unit_id')
            ...
            <div class="row my-5 d-flex align-items-center">
              ...
              <div class="col-md-9 mb-2">
                ...
                <button wire:click="$emitUp('itemAdded')" class="btn btn-secondary btn-sm"><i class="fa-solid fa-pencil"></i>Test</button>
              </div>
            </div>
          </div>
